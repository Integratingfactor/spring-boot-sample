...
<!-- override CSS -->
<link href="/css/jumbotran.css" rel="stylesheet">
...
<body>
	...
	<div class="jumbotron">
      <div class="container">
        <h1>Integrate technology into life!</h1>
        <p/>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <p><a class="btn btn-default" href="http://tech-blog.integratingfactor.com" role="button">View details</a></p>
       </div>
        <div class="col-md-4">
          <h2>About</h2>
          <p>Learn more about Integratingfactor.com</p>
          <br>
          <p><a class="btn btn-default" href="http://story.integratingfactor.com" role="button">View details</a></p>
        </div>
      </div>
